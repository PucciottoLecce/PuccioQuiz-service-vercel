...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fafaf8;">
  <tr><td align="center" style="padding:32px 16px;">
    <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
      ...
      <!-- HEADER -->
      <tr>
        <td align="center" style="background-color:#C0392B;padding:28px 32px;">
          <div style="font-family:Georgia,serif;font-size:32px;font-weight:bold;color:#ffffff;letter-spacing:1px;margin:0;">Pucciotto</div>
          <div style="font-size:13px;color:rgba(255,255,255,0.8);margin-top:6px;">La puccia 2.0 — Lecce</div>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:28px 32px;background-color:#ffffff;">
          ...
          <p style="font-size:14px;color:#555555;margin:0 0 24px 0;line-height:1.5;">
            Hai completato il PuccioQuiz e hai vinto un omaggio.<br/>Mostra il token qui sotto in negozio per ritirarlo.
          </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff8f4;border:1px solid #fde8e2;border-radius:12px;margin-bottom:20px;">
            <tr>
              <td align="center" style="padding:20px 24px;">
                ...
                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#C0392B;margin-bottom:6px;">Il tuo omaggio</div>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fafaf8;border:2px dashed #e8e4e0;border-radius:12px;margin-bottom:24px;">
            <tr>
              <td align="center" style="padding:18px 20px;">
                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#999999;margin-bottom:8px;">Token da mostrare in cassa</div>
          ...
          <p style="font-size:13px;color:#777777;margin:0;line-height:1.6;">
            📍 Vieni a trovarci in <strong style="color:#1a1a1a;">Via dei Biccari 15, Lecce</strong> e mostra questo token alla cassa per ritirare il tuo omaggio.
          </p>
