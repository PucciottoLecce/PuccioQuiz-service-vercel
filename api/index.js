    ...
    <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
      ...
      <tr>
        <td align="center" style="background-color:#C0392B;padding:28px 32px;">
          <img src="https://raw.githubusercontent.com/PucciottoLecce/OrderPucciotto/main/frontend/public/logo.png" alt="Pucciotto" width="160" style="display:block;margin:0 auto;max-width:160px;height:auto;" />
